...
<body>
    ...
    <header id="header"> 
      ...
      <div id="engine" class="baner"><span></span></div>
      <div class="z">


      <div id="usługi2" class="container my-5 py-3 p-0 px-lg-5 ">
        <h1 class="display-5 p-2 text-center align-content-center">{tytul}</h1>
       <row class="row justify-content-center align-content-center p-4"> 
        <div class="col-10 lead fs-3 px-2">
          {content}
       </div>
   </div>
    </div>
