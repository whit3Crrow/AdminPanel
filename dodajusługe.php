...
<body>
    <header class="d-flex justify-content-center bg-dark text-white-50 p-2 display-1 ">Dodawanie Usługi</header>
    <div class="m-4"></div>
    ...
    <div class="container myboxshadow rounded-3 border my-4 p-3">
        <form class="d-flex flex-column" method="post" enctype="multipart/form-data" action="send_dodajusługe.php" >
            <label class="lead fs-3">Tytuł usługi</label>
            <input class="m-2 border" name="title" placeholder="Nagłówek" ></input>
            <label  class="lead fs-3">Krótkie streszczenie usługi</label>
            <input type="text" maxlength="160" class="m-2 border" name="summary" placeholder="Opis"></input>
            <label class="lead fs-3">Miniatura dla usługi</label>
            <input class="m-2 border" type="file" name="image"></input>
            <label class="lead fs-3">Baner strony (zostaw puste jeśli chcesz dodać domyślny)</label>
            <input class="m-2 border" type="file" name="baner"></input>
            <label class="lead fs-3">Strona Usługi</label>
            ...
            <button type="submit" class="btn btn-outline-success myboxshadow p-2 w-100">Dodaj Usługę</button>
        </form>
    </div>
</body>
