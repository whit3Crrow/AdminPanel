...
<body>
    ...
    <header id="header"> 
      ...
      <div id="baner"class="baner" style="background-image: url(../uploads/sowacki6_small_elegant_bmw_with_2_streams_of_paint_fowarding_t_29c26481-dbf9-4519-8a2a-d5768e5184a0.png);"></div>
      <div class="z">


      <div id="usługi" class="container my-5 py-3 p-0 px-lg-5 motocarslead">
        <h1 class="display-5 p-2 text-center align-content-center">Lakiernictwo</h1>
        ...
        <div class="col-12 lead fs-3 px-2 ">
            <p><strong>Lakiernictwo samochodowe</strong> to specjalistyczna usługa, która obejmuje malowanie, lakierowanie, naprawę i renowację powierzchni pojazdów, zarówno dla celów estetycznych, jak i ochronnych. Celem lakiernictwa jest przywrócenie wyglądu fabrycznego samochodu, ochrona przed czynnikami zewnętrznymi, takimi jak słońce, woda, sól oraz ochrona przed korozją. Fachowcy z zakładu lakierniczego dobierają odpowiednie materiały, takie jak farby, lakiery i podkłady, a także stosują właściwe techniki malowania, aby uzyskać jak najlepsze efekty. Prace lakiernicze często są wymagane po wypadkach drogowych, ale także w celu odświeżenia wyglądu pojazdu czy zmiany koloru. Wysokiej jakości usługa lakiernictwa samochodowego zapewnia trwałość i estetykę wykończenia, a także zwiększa wartość pojazdu.</p>
        </div>
