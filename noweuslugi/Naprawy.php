...
<body>
    ...
    <header id="header"> 
      ...
      <div id="baner"class="baner" style="background-image: url(../uploads/sowacki6_repearing_car_engine_de9e9ae2-5f1f-4bd6-81d4-a35f4f982871.png);"></div>
      <div class="z">


      <div id="usługi" class="container my-5 py-3 p-0 px-lg-5 motocarslead">
        <h1 class="display-5 p-2 text-center align-content-center">Naprawy</h1>
        ...
        <div class="col-12 lead fs-3 px-2 ">
            <p>Naprawy samochodowe to szeroki zakres usług mających na celu utrzymanie pojazdów w jak najlepszej kondycji technicznej, co przekłada się na bezpieczną i komfortową jazdę. Specjaliści z zakładów naprawczych zajmują się diagnostyką usterek, konserwacją, naprawą lub wymianą uszkodzonych części, a także przeprowadzaniem bieżących przeglądów.</p><p><br></p><p>Naprawy samochodowe obejmują szeroki zakres działań, takich jak naprawa silników, układów hamulcowych, zawieszenia, układów kierowniczych, elektrycznych czy klimatyzacji. Wykwalifikowani mechanicy są w stanie zdiagnozować i naprawić wiele problemów, które mogą wystąpić w trakcie eksploatacji pojazdu.</p><p><br></p><p>Regularne naprawy oraz serwisowanie samochodu są niezbędne dla utrzymania pojazdu w dobrej kondycji, co wpływa na długowieczność auta, bezpieczeństwo podróży oraz ogólną satysfakcję z użytkowania. Wybór profesjonalnych i doświadczonych warsztatów gwarantuje wysoką jakość świadczonych usług oraz pewność, że naprawy są przeprowadzane zgodnie z zaleceniami producenta pojazdu.</p>
        </div>
